...
import '/screen/login/login_otp_screen.dart';
...
class _SignInMobileScreenState extends State<SignInMobileScreen> {
  ...
  void initState() {
    super.initState();
    countryCode = countryCodePicker.countryCodes.firstWhere((element) => element.name == "Yemen");
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Image.asset("assets/img/logo2.png",
                      width: context.width * 0.65, fit: BoxFit.fitWidth),
